...
void AddressWidget::showAddEntryDialog()
{
    ...
    if (aDialog.exec())
        addEntry(aDialog.name(), aDialog.address(), aDialog.email(), aDialog.phone());
}

void AddressWidget::addEntry(const QString &name, const QString &address, const QString &email, const QString &phone)
{
    if (!table->getContacts().contains({ name, address, email, phone })) {
...
void AddressWidget::editEntry()
{
    ...
    aDialog.editAddress(name, address, email, phone);
...
void AddressWidget::readFromFile(const QString &fileName)
{
    ...
    if (contacts.isEmpty()) {
        ...
        for (const auto &contact: std::as_const(contacts))
            addEntry(contact.name, contact.address, contact.email, contact.phone);
    }
}
